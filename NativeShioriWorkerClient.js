...
(function() {
  var BrowserFS, NanikaStorage, NativeShioriWorkerClient, _window, buffer, path;
  ...
  NativeShioriWorkerClient = (function() {
    ...
    NativeShioriWorkerClient.prototype.load = function(dirpath) {
      ...
      this.storage = new NanikaStorage(new NanikaStorage.Backend.FS(fs_root, this.fs, path, buffer.Buffer));
